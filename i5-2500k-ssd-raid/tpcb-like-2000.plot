...
set output 'tpcb-like-2000.eps'

set title "transactions per second (tpcb-like scale 2000)" font ",14"
set ylabel "TPS"
...
plot "tpcb-like-2000.csv" using 2:xtic(1) title "flush" linecolor rgb "#CC0000", \
