...
set output 'tpcb-like-300.eps'

set title "transactions per second (tpcb-like scale 300)" font ",14"
set ylabel "TPS"
...
plot "tpcb-like-300.csv" using 2:xtic(1) title "flush" linecolor rgb "#CC0000", \
