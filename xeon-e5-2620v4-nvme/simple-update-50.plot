...
set output 'simple-update-50.eps'

set title "transactions per second (simple-update scale 50)" font ",14"
set ylabel "TPS"
...
plot "simple-update-50.csv" using 2:xtic(1) title "flush" linecolor rgb "#CC0000", \
